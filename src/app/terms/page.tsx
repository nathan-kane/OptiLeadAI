        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="space-y-3 text-slate-700 mb-4">
              <li>• OptiLeads provides tools for lead generation, CRM functionality, and related services.</li>
            ...
            <ul className="space-y-2 text-slate-700 ml-4">
              ...
              <li>• Use the Service for spamming, harassment, or unlawful activities.</li>
          ...
          <section>
            ...
            <ul className="space-y-3 text-slate-700">
              <li>• All content, trademarks, logos, and software associated with OptiLeads are the property of OptiLeads and are protected by copyright and intellectual property laws.</li>
              <li>• You are granted a limited, non-exclusive, non-transferable license to use the Service for your business purposes.</li>
              <li>• You may not reproduce, distribute, or create derivative works without our prior written consent.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">5. Payments and Subscriptions</h2>
            <ul className="space-y-3 text-slate-700">
              ...
              <li>• We reserve the right to change pricing, and we will provide advance notice of any changes.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-3 text-slate-700">
              <li>• Your use of the Service is also governed by our <Link href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</Link>.</li>
              <li>• By using OptiLeads, you consent to the collection and use of information as described in the Privacy Policy.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-700">
              The Service may integrate with third-party services (e.g., payment processors, communication APIs). We are not responsible for the content, policies, or actions of third parties.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-3 text-slate-700">
              ...
              <li>• We make no warranty as to the accuracy or reliability of any leads or data provided.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-700">
              To the fullest extent permitted by law, OptiLeads and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including lost profits or data, arising out of or related to your use of the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-3 text-slate-700">
              ...
              <li>• Provisions relating to intellectual property, liability, and indemnification shall survive termination.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-4">12. Changes to These Terms</h2>
            <p className="text-slate-700">
