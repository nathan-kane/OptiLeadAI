      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <PageHeader
                  ...
                  description="Manage your title company partners."
                />
        </div>
      ...
      {titleCompanies.length === 0 ? (
        <Card className="shadow-xl border-0 bg-white rounded-2xl overflow-hidden">
          <CardContent className="flex flex-col items-center justify-center py-12 px-6">
            ...
            <h3 className="text-xl font-extrabold text-slate-900 mb-2">No title companies found</h3>
        ...
        <Card className="shadow-xl border-0 bg-white rounded-2xl overflow-hidden">
          <CardHeader className="px-2 sm:px-6 py-6 bg-gradient-to-r from-blue-50 to-green-50 border-b border-gray-100">
            <CardTitle className="text-2xl sm:text-3xl font-extrabold text-slate-900">Title Companies</CardTitle>
            <CardDescription className="text-base sm:text-lg text-slate-600">
              Showing {titleCompanies.length} title company partners. Manage your closing network.
            </CardDescription>
          </CardHeader>
